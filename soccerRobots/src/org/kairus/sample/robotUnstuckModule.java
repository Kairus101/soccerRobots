...
public class robotUnstuckModule extends RobotModule {
	...
	int countTillMove = 0;
	int maxCountTillMove = 200/((KairusTeam)team).framesBetweenCalculation;
	int maxCount = 230/((KairusTeam)team).framesBetweenCalculation;
	...
	boolean execute(Team team) {
		team.SetSpeedInput(robotNumber, -0.2f);
